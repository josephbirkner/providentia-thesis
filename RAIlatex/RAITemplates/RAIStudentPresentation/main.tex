...
\def\PresentationType{\RAIlangGerEng{Auftaktvortrag}{Initial Presentation}}%
%\def\PresentationType{\RAIlangGerEng{Abschlussvortrag}{Final Presentation}}%
\def\PresentationThesisType{\RAIlangBachelorsThesis}%
%\def\PresentationThesisType{\RAIlangSemesterThesis}%
%\def\PresentationThesisType{\RAIlangMastersThesis}%
%\def\PresentationThesisType{\RAIlangInterdisciplinaryProject}%
\author[Short-Name]{Your Name}%
\def\PresentationExaminer{\RAInamesProfKnoll}%
\def\PresentationSupervisor{Your Supervisor}%
\date{\RAIutilsDate{1}{1}{2017}}%
%
% Setup of header and footer
\RAIbeamerSetupHeader{\RAIlayoutHeaderCustomChair}%

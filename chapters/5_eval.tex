...
\begin{table*}[htbp]
    \input{charts/resolution-best}
    \caption{Best results for different instance segmentation models, with differences in the resulting metrics shown towards the overall best model's values.}

...
$\Delta$ {Best} & ${\scriptstyle\color{red}+56.08\degree}$ & ${\scriptstyle\color{TUMGreen}-0.01m}$ & ${\scriptstyle\color{red}+0.02m}$ & ${\scriptstyle\color{TUMGreen}-0.01m}$ & ${\scriptstyle\color{black}0.00m}$ & ${\scriptstyle\color{red}-2.73\%}$ & ${\scriptstyle\color{red}-0.58\%}$ & ${\scriptstyle\color{red}-0.51\%}$ & ${\scriptstyle\color{red}-0.56\%}$ \\ 

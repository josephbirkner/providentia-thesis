...
\RAIstudentthesisTitlePageCustomMastersThesis{Zweistufige Monokulare 3D Objekterkennung mit HD-Karten in Städtischen Szenarien}{Two-stage Monocular 3D Object Detection Using HD Maps in Urban Settings}{\RAIlangFieldOfStudyInformatics}{Joseph Birkner}{}{\RAInamesProfKnoll}{Walter Zimmer, M.Sc.}{\RAIutilsDate{31}{3}{2023}}%
%
% Abstract
% --------
...
\include{chapters/2_related}
\include{chapters/3_tech}
\include{chapters/4_system}
\include{chapters/5_eval}
